...
public class IndividuoFuncion2 extends Individuo<Boolean> implements Cloneable {
	...
	public IndividuoFuncion2() {
		...
		// Inicializamos el cromosoma con valores aleatorios (booleanos)
	...
	protected IndividuoFuncion2 clone() throws CloneNotSupportedException {
		// TODO Auto-generated method stub
		return (IndividuoFuncion2) super.clone();
	}
	...
	public double getValor() {
        ...
        // Calculamos el valor de la función 2
        return Math.sin(x2) * Math.pow(Math.E, Math.pow(1 - Math.cos(x1), 2)) 
            + Math.cos(x1) * Math.pow(Math.E, Math.pow(1 - Math.sin(x2), 2))
            + Math.pow(x1 - x2, 2);
    }
	...
	public void cruzarUniforme(IndividuoFuncion2 otro) {
	...
	public void cruzarMonopunto(IndividuoFuncion2 padre2) {
		Random rand = new Random();
