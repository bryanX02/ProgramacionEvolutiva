...
import modelo.IndividuoFuncion4;
import modelo.PoblacionFun4;

import javax.swing.*;
import java.awt.*;
import java.util.ArrayList;

public class Funcion4 extends JFrame {
    ...
    private void ejecutarAlgoritmo() {
        ...
        PoblacionFun4 poblacion = new PoblacionFun4(tamPoblacion, algoritmo);
        
        poblacion.iniciarGeneracion(dimensiones);
        ArrayList<PoblacionFun4> generaciones = new ArrayList<>();
        ...
        for (int i = 1; i <= maxGeneraciones; i++) {
            PoblacionFun4 nuevaPoblacion = poblacion.seleccionarSegun(metodoSeleccion);
