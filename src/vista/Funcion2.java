...
import modelo.IndividuoFuncion2;  // Cambiado a la clase correspondiente para función 2
import modelo.PoblacionFun2;      // Cambiado a la clase correspondiente para función 2

import javax.swing.*;
import java.awt.*;
import java.util.ArrayList;

public class Funcion2 extends JFrame {
    ...
    private void ejecutarAlgoritmo() {
        ...
        AlgoritmoGenetico algoritmo = new AlgoritmoGenetico(tamPoblacion, maxGeneraciones, probCruce, probMutacion, elitismo, 2); // Cambiar a función 2
        PoblacionFun2 poblacion = new PoblacionFun2(tamPoblacion, algoritmo);
        
        poblacion.iniciarGeneracion();
        ArrayList<PoblacionFun2> generaciones = new ArrayList<>();
        ...
        double mejorAbsoluto = Double.MAX_VALUE;  // Cambiar a valor máximo para la minimización
        
        for (int i = 1; i <= maxGeneraciones; i++) {
        	System.out.println(poblacion.size());
            PoblacionFun2 nuevaPoblacion = poblacion.seleccionarSegun(metodoSeleccion);
            ...
            if (mejor < mejorAbsoluto) mejorAbsoluto = mejor; // Seleccionar el mínimo
