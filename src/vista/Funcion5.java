...
import modelo.IndividuoFuncion5;
import modelo.PoblacionFun5;

import javax.swing.*;
import java.awt.*;
import java.util.ArrayList;

public class Funcion5 extends JFrame {
    ...
    private void ejecutarAlgoritmo() {
        ...
        AlgoritmoGenetico algoritmo = new AlgoritmoGenetico(tamPoblacion, maxGeneraciones, probCruce, probMutacion, elitismo, dimensiones);
        PoblacionFun5 poblacion = new PoblacionFun5(tamPoblacion, algoritmo);
        
        poblacion.iniciarGeneracion(dimensiones);
        ArrayList<PoblacionFun5> generaciones = new ArrayList<>();
        ...
        for (int i = 1; i <= maxGeneraciones; i++) {
            PoblacionFun5 nuevaPoblacion = poblacion.seleccionarSegun(metodoSeleccion);
